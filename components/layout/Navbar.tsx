              ...
              >
                <div className={`w-10 h-10 flex items-center justify-center transition-colors ${
                  ...
                  <span className={`font-heading font-bold text-xl transition-colors ${
                    showTransparent ? 'text-primary' : 'text-white'
                  }`}>
                    DP
                  </span>
                </div>
                <div className="hidden sm:block">
                  ...
                  <span className={`block text-xs font-body tracking-[0.2em] uppercase transition-colors ${
                    showTransparent ? 'text-white/70' : 'text-text-muted'
                  }`}>
                    Estate
                  </span>
                </div>
            ...
            <div className="hidden lg:flex items-center gap-1">
              {navLinks.map((link) => (
                ...
                >
                  <Link
                    href={link.href}
                    className={`px-4 py-2 font-body text-sm font-medium transition-colors relative group ${
                      showTransparent
                  ...
                  >
                    ...
                    <span className={`absolute bottom-0 left-4 right-4 h-0.5 scale-x-0 group-hover:scale-x-100 transition-transform origin-left ${
                      showTransparent ? 'bg-secondary' : 'bg-primary'
                    }`} />
                  </Link>
            ...
            <div className="flex items-center gap-4">
              ...
              <motion.button
                className={`p-2 transition-colors ${
                  showTransparent ? 'text-white hover:text-secondary' : 'text-text-main hover:text-primary'
                }`}
              ...
              <div className="hidden md:block">
                <Link
                  href="/contact"
                  className={`inline-flex items-center justify-center px-6 py-2.5 font-body font-semibold text-sm tracking-wide border-2 transition-all duration-300 ${
                    showTransparent
