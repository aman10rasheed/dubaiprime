...
export default function PropertiesPageClient({
    ...
    return (
        <div className="pt-24">
            ...
            <section className="bg-primary py-20">
                <div className="container-luxury">
                    <AnimatedSection animation="fadeUp">
                        ...
                        <h1 className="font-heading text-white mb-4">Our Properties</h1>
            ...
            {/* Filters */}
            <section className="bg-white border-b border-accent sticky top-20 z-30">
                <div className="container-luxury py-6">
                    <div className="flex flex-wrap items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            {[
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 font-body text-sm transition-colors ${listingType === option.value
                        ...
                        <select
                            ...
                            className="px-4 py-2 bg-accent font-body text-sm text-text-main focus:outline-none focus:ring-1 focus:ring-primary"
                        >
                        ...
                        {/* View Toggle */}
                        <div className="hidden md:flex items-center gap-1 bg-accent">
                            <button
                                onClick={() => setViewMode('grid')}
                                className={`p-2 transition-colors ${viewMode === 'grid' ? 'bg-primary text-white' : 'text-text-muted'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`p-2 transition-colors ${viewMode === 'list' ? 'bg-primary text-white' : 'text-text-muted'
                                    }`}
                            >
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
